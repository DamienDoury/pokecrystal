...
endr
	...
	tilepal 1, RED, RED, GRAY, GRAY, YELLOW, GRAY, GRAY, BROWN
	tilepal 1, RED, RED, YELLOW, YELLOW, WATER, WATER, BROWN, BROWN
	tilepal 1, RED, RED, GRAY, GRAY, YELLOW, ROOF, ROOF, BROWN
	tilepal 1, RED, RED, YELLOW, YELLOW, ROOF, ROOF, GRAY, GRAY
	tilepal 1, RED, RED, GRAY, GRAY, YELLOW, ROOF, ROOF, YELLOW

...
endr
	...
	tilepal 1, YELLOW, YELLOW, GRAY, GRAY, RED, RED, ROOF, ROOF
	...
	tilepal 1, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY
	tilepal 1, ROOF, ROOF, GRAY, YELLOW, RED, RED, YELLOW, WATER
	tilepal 1, GRAY, GRAY, GRAY, GRAY, GRAY, WATER, GRAY, GREEN
	tilepal 1, ROOF, ROOF, WATER, YELLOW, WATER, WATER, YELLOW, YELLOW

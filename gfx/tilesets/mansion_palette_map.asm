...
endr
	...
	tilepal 1, RED, GREEN, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY
	tilepal 1, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY, GRAY
	tilepal 1, BROWN, BROWN, GREEN, RED, GRAY, GRAY, GRAY, WATER
	tilepal 1, GRAY, GRAY, GRAY, GRAY, GRAY, WATER, GRAY, YELLOW
	tilepal 1, BROWN, BROWN, WATER, BROWN, GRAY, GRAY, GRAY, WATER

...
; https://www.youtube.com/watch?v=xLMei8qvNb8
; https://github.com/TriteHexagon/Trite_ASM_Repository/blob/main/extra%20wave/route10.asm

; Add this wave to audio/wave_samples.asm

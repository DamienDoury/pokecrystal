...
.end_stat_exp_loop
	...
	ld [hl], POKERUS_ORIGINAL_STRAIN | (POKERUS_SYMPTOMS_START - 1) ; We say the Pikachu has been infected by the XP variant (useless as level 100), and is currently sick and checked. He hasn't been vaccinated.
	inc hl

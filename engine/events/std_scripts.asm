...
InitializeEventsScript:
	...
	setevent EVENT_GOT_SQUIRTBOTTLE_INVERSE_FLAG
	...
	setevent EVENT_MART_GOLDENROD_2F_MISSED
	setevent EVENT_MART_GOLDENROD_4F_1_MISSED
	setevent EVENT_MART_GOLDENROD_4F_2_MISSED

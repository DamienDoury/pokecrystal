...
.MenuAction_OakCall:
	farcall ProfOaksPCBoot
	jmp Pokedex_DisplayModeDescription
...
.OakEval:
if DEF(_FR_FR)
	db   "Avis sur l'avance-"
	next "ment du #DEX.@"
else
	db   "Completion review"
	next "of your #DEX.@"
endc
...
PokedexLZ:
if DEF(_FR_FR)
INCBIN "gfx/pokedex/pokedex_fr.2bpp.lz"
else

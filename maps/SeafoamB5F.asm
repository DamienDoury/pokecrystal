...
SeafoamB5F_MapEvents:
	...
	object_event 24,  7, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SeafoamB5FItem, EVENT_VOLCANO_CHARCOAL
	...
	object_event 18,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SeafoamB5FItem2, EVENT_VOLCANO_FIRE_STONE

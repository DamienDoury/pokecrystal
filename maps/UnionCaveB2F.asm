...
.Script:
	endifjustbattled
	jumptextfaceplayer CooltrainermNickAfterBattleText
...
.Script:
	endifjustbattled
	jumptextfaceplayer CooltrainerfEmmaAfterBattleText
...
UnionCaveB2F_MapEvents:
	...
	object_event  5, 13, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, HIDE_CURFEW, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 2, TrainerCooltrainerfGwen, -1

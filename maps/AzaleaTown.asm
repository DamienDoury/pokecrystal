...
AzaleaTown_MapEvents:
	...
	object_event 20,  8, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AzaleaTownGrampsRush, EVENT_LOCKDOWN_MART_RUSH
	object_event 22,  6, SPRITE_TEACHER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AzaleaTownTeacherRush, EVENT_LOCKDOWN_MART_RUSH
	object_event 21,  6, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, AzaleaTownTeacherRush, EVENT_LOCKDOWN_MART_RUSH
	object_event 21,  7, SPRITE_POKEFAN_M, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AzaleaTownPokefanRush, EVENT_LOCKDOWN_MART_RUSH
	object_event 22,  9, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, AzaleaTownApprenticeRush, EVENT_LOCKDOWN_MART_RUSH

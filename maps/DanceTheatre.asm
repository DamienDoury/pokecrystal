...
DanceTheatre_MapEvents:
	...
	object_event 10, 10, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, HIDE_CURFEW, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, DanceTheatreCooltrainerMScript, -1
	object_event  3,  6, SPRITE_GRANNY, SPRITEMOVEDATA_STANDING_UP, 0, 0, HIDE_CURFEW, -1, 0, OBJECTTYPE_SCRIPT, 0, DanceTheatreGrannyScript, -1

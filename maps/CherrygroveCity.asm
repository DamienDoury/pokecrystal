...
CherrygroveCity_MapEvents:
	...
	object_event 23,  4, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, FirstInLineFirstLockdown, EVENT_LOCKDOWN_MART_RUSH
	object_event 22,  4, SPRITE_FISHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, MysticWaterGuyFirstLockdown, EVENT_LOCKDOWN_MART_RUSH
	object_event 24,  4, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, CooltrainerFirstLockdown, EVENT_LOCKDOWN_MART_RUSH

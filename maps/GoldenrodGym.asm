...
WhitneyCriesScript:
	turnobject GOLDENRODGYM_LASS2, LEFT
	showemote EMOTE_SHOCK, GOLDENRODGYM_LASS2, 15
	turnobject PLAYER, RIGHT
	clearevent EVENT_MADE_WHITNEY_CRY
	jumptext BridgetWhitneyCriesText
...
GoldenrodGym_MapEvents:
	...
	object_event 10,  6, SPRITE_LASS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 2, TrainerLassBridget, -1

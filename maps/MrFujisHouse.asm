...
MrFujisHouse_MapEvents:
	...
	object_event  7,  3, SPRITE_PSYDUCK, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, MrFujisPsyduck, -1
	...
	object_event  2,  3, SPRITE_JASMINE, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, MrFujisJasmineScript, EVENT_JASMINE_AT_FUJIS

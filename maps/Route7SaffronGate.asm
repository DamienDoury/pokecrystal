...
Route7SaffronGate_MapEvents:
	...
	def_coord_events
	coord_event  7,  5, SCENE_DEFAULT, Route7SaffronGateCrossOakScript
	coord_event  7,  4, SCENE_DEFAULT, Route7SaffronGateCrossOakScript
	coord_event  7,  5, SCENE_FINISHED, Route7SaffronGateCrossOakScript
	coord_event  7,  4, SCENE_FINISHED, Route7SaffronGateCrossOakScript

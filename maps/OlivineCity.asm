...
OlivineCity_MapEvents:
	...
	object_event 26, 27, SPRITE_SAILOR, CLAP_F | SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, HIDE_LOCKDOWN & HIDE_CURFEW, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineCitySailor1Script, -1
	...
	object_event 17, 21, SPRITE_SAILOR, CLAP_F | SPRITEMOVEDATA_WANDER, 1, 1, HIDE_LOCKDOWN & HIDE_CURFEW, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineCitySailor2Script, -1

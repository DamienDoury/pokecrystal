...
OlivineCity_MapEvents:
	...
	def_object_events
	object_event 15, 22, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, HIDE_FREE & HIDE_VACCINE_PASS, %11100000 | DAY | NITE, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, TravelController, -1
	object_event 26, 27, SPRITE_SAILOR, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, HIDE_LOCKDOWN, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineCitySailor1Script, -1

...
Route8_MapEvents:
	...
	object_event 39,  8, SPRITE_JASMINE, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_AMPHY_BURIAL_CEREMONY_IN_PROGRESS
	object_event 37,  8, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_AMPHY_BURIAL_CEREMONY_IN_PROGRESS
	object_event 35,  8, SPRITE_CLERK, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route8BurialGuyScript, EVENT_AMPHY_BURIAL_CEREMONY_IN_PROGRESS
	object_event 40, 10, SPRITE_BEAUTY, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_AMPHY_BURIAL_CEREMONY_IN_PROGRESS
	object_event 40,  7, SPRITE_SAILOR, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_AMPHY_BURIAL_CEREMONY_IN_PROGRESS

...
Route8_MapEvents:
	...
	object_event 39,  8, SPRITE_JASMINE, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, Route8JasmineScript, EVENT_AMPHY_BURIAL_CEREMONY_IN_PROGRESS
	object_event 37,  8, SPRITE_TEACHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, Route8JasmineScript, EVENT_AMPHY_BURIAL_CEREMONY_IN_PROGRESS
	object_event 35,  8, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, Route8BurialGuyScript, EVENT_AMPHY_BURIAL_CEREMONY_IN_PROGRESS

...
LavenderTown_MapEvents:
	...
	object_event  8,  5, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, LavenderTownPasserby5Script, EVENT_AMPHY_BURIAL_CEREMONY_JUST_FINISHED

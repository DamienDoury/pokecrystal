...
GoldenrodHospitalCorridor_MapEvents:
	...
	object_event 13, 11, SPRITE_POKEFAN_M, SPRITEMOVEDATA_PATROL_CIRCLE_LEFT, 2, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 0, GoldenrodHospitalCorridorPokefan1Script, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_5

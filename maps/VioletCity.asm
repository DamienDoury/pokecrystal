...
VioletCity_MapEvents:
	...
	object_event  9, 18, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LockdownNPC1Script, EVENT_LOCKDOWN_MART_RUSH
	object_event  9, 20, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LockdownNPC1Script, EVENT_LOCKDOWN_MART_RUSH
	object_event 11, 20, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LockdownNPC3Script, EVENT_LOCKDOWN_MART_RUSH
	object_event 13, 20, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, LockdownNPC4Script, EVENT_LOCKDOWN_MART_RUSH

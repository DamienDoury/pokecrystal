...
Route40_MapEvents:
	...
	def_object_events
	object_event 14, 15, SPRITE_OLIVINE_RIVAL, SPRITEMOVEDATA_SWIMPATROL_CIRCLE_LEFT, 2, 0, HIDE_LOCKDOWN, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 3, TrainerSwimmermSimon, -1

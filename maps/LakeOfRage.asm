...
LakeOfRage_MapEvents:
	...
	object_event  4, 15, SPRITE_COOLTRAINER_M, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, HIDE_LOCKDOWN & HIDE_CURFEW, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 2, TrainerCooltrainermAaron, EVENT_LAKE_OF_RAGE_CIVILIANS

...
VaccinationCenter1F_MapEvents:
	...
	object_event  6,  3, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | DAY, 0, OBJECTTYPE_SCRIPT, 0, VaccinationCenterEmptyScript, EVENT_CROWD_IN_VACCINATION_CENTER
	...
	object_event  9,  1, SPRITE_TWIN, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | NITE, 0, OBJECTTYPE_SCRIPT, 0, VaccinationCenterEmptyScript, EVENT_CROWD_IN_VACCINATION_CENTER

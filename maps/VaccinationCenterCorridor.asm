...
if DEF(_FR_FR)
	text "Attendez ici, le"
	line "médecin va vous"
	cont "appeler dans un"
	cont "instant."
else
    text "Wait here, the"
...
VaccinationCenterCorridor_MapEvents:
    ...
    def_object_events
	object_event 12,  2, SPRITE_LINK_RECEPTIONIST, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_PINK, OBJECTTYPE_SCRIPT, 0, ObjectEvent, -1
	object_event  1,  0, SPRITE_HOSPITAL_VISITOR, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_2

	object_event  3,  1, SPRITE_GENTLEMAN, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | MORN, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_3
	object_event  3,  1, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | DAY, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_3
	object_event  3,  1, SPRITE_FISHER, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | NITE, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEMPORARY_UNTIL_MAP_RELOAD_3

    object_event  7,  1, SPRITE_ERIKA, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | MORN, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_CROWD_IN_VACCINATION_CENTER
	object_event 11,  1, SPRITE_SAGE, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | MORN, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_CROWD_IN_VACCINATION_CENTER
	object_event 15,  1, SPRITE_GRANNY, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | MORN, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_CROWD_IN_VACCINATION_CENTER

    object_event  7,  1, SPRITE_GRAMPS, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | DAY, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_CROWD_IN_VACCINATION_CENTER
	object_event 11,  1, SPRITE_BEAUTY, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | DAY, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_CROWD_IN_VACCINATION_CENTER
	object_event 15,  1, SPRITE_FISHER, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | DAY, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_CROWD_IN_VACCINATION_CENTER

    object_event  7,  1, SPRITE_CLERK, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | NITE, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_CROWD_IN_VACCINATION_CENTER
	object_event 11,  1, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | NITE, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_CROWD_IN_VACCINATION_CENTER
	object_event 15,  1, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STILL, 0, 0, -1, %11100000 | NITE, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_CROWD_IN_VACCINATION_CENTER

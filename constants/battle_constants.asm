...
MAX_LEVEL EQU 100
MIN_LEVEL EQU 2
EGG_LEVEL EQU 2 ; Edited by Damien.
...
BATTLERESULT_CAUGHT_POKEMON EQU 4
BATTLERESULT_CAUGHT_MEWTWO EQU 5
BATTLERESULT_CAUGHT_CELEBI EQU 6
BATTLERESULT_BOX_FULL EQU 7
BATTLERESULT_BITMASK EQU (1 << BATTLERESULT_CAUGHT_POKEMON) | (1 << BATTLERESULT_CAUGHT_MEWTWO) | (1 << BATTLERESULT_CAUGHT_CELEBI) | (1 << BATTLERESULT_BOX_FULL)

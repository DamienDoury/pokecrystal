...
NUM_ATTACKS EQU const_value - 1
	const_skip          ; fd
	const_skip          ; fe
	const SWEET_SCENT_2 ; ff

; Battle animations use the same constants as the moves up to this point
	const_next $100
	const ANIM_CONFUSED          ; 100
	const ANIM_SLP               ; 101
	const ANIM_BRN               ; 102
	const ANIM_PSN               ; 103
	const ANIM_SAP               ; 104
	const ANIM_FRZ               ; 105
	const ANIM_PAR               ; 106
	const ANIM_IN_LOVE           ; 107
	const ANIM_IN_SANDSTORM      ; 108
	const ANIM_IN_NIGHTMARE      ; 109
	const ANIM_IN_WHIRLPOOL      ; 10a
	const ANIM_IN_HAIL           ; 10b

; move anims below ANIM_THROW_POKE_BALL won't be affected by BATTLE SCENE: OFF.
	const ANIM_THROW_POKE_BALL   ; 10c
	const ANIM_SEND_OUT_MON      ; 10d
	const ANIM_RETURN_MON        ; 10e

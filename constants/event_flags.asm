...
; Johto story events
	...
	const EVENT_GOT_COVID_SAMPLE_FROM_MR_POKEMON
	const EVENT_GAVE_COVID_SAMPLE_TO_ELM
	...
	const EVENT_ELM_ENCOURAGED_TO_GET_VACCINATED
	...
	const EVENT_ALL_PLANTS_DIED_DURING_LOCKDOWN
	const EVENT_CLEARED_SLOWPOKE_WELL
	const EVENT_EXPLAIN_SHORTAGE_MECHANICS
	const EVENT_GOT_TOGEPI_EGG
	...
	const EVENT_FIRST_LOCKDOWN_STARTED
	const EVENT_NON_ESSENTIAL_BUILDING
	const EVENT_HEALED_MOOMOO
	const EVENT_FIRST_POLICE_BATTLE
	const EVENT_TALKED_TO_FARMER_ABOUT_MOOMOO
	const EVENT_TALKED_TO_MOM_AFTER_MYSTERY_EGG_QUEST
	const EVENT_ALLOWED_ACCESS_TO_VICTORY_ROAD
	...
	const EVENT_GAVE_SHUCKIE_BACK
	const EVENT_FOUND_HOSPITAL
	...
	const EVENT_GOT_SICK_WHILE_HOLDING_JADE_CRYSTAL
	...
	const EVENT_STONE_SCAMMER_IS_SELLING
	const EVENT_GOT_CLEAR_BELL
	const EVENT_CHERRYGROVECITY_MEET_RIVAL
	const EVENT_RECEIVED_CURFEW_SPECIAL_CALL
...
; Johto hidden items
	...
	const EVENT_GOT_DAMIANS_CHARMANDER
	const EVENT_PCR_TEST_PRESENTATION
	const EVENT_ICE_PATH_EXPLORED
...
; Crystal-exclusive events in Johto
	...
	const EVENT_REDS_PIKACHU_AVAILABLE
	const EVENT_LOCKDOWN_MART_RUSH
	const EVENT_GOT_BASEMENT_KEY
	const EVENT_FIRST_CURFEW_STARTED
	const EVENT_CATCHING_TUTORIAL_AVAILABLE
...
; Kanto hidden items
	...
	const EVENT_FUCSHIA_RARE_CANDY
	const EVENT_FUCSHIA_LUCKY_PUNCH
	const EVENT_FUCSHIA_POKEBALL
	const EVENT_FUCSHIA_KINGS_ROCK
	const EVENT_FOUND_HELIX_FOSSIL
	const EVENT_FUCHSIA_SLOWPOKETAIL
	const EVENT_FUCHSIA_STARDUST
	const EVENT_FUCHSIA_BURN_HEAL
	const EVENT_FUCHSIA_LEFTOVERS
	const EVENT_FUCHSIA_TOILET_PAPER
	const EVENT_FUCHSIA_LEMONADE
	const EVENT_FOUND_FUCHSIA_MAX_ELIXER
	const EVENT_FOUND_CINNABAR_SODA_1
	const EVENT_FOUND_CINNABAR_SODA_2
	const EVENT_FOUND_CINNABAR_SODA_3

	const EVENT_AMPHY_BURIAL_CEREMONY_IN_PROGRESS
	const EVENT_FUCHSIA_EXCAVATION_STARTED
	const EVENT_CINNABAR_RAVE_PARTY
	const EVENT_CINNABAR_FRESH_WATER
	const EVENT_CINNABAR_GAVE_WATER
	const EVENT_CINNABAR_MAX_REVIVE
	const EVENT_MOUNT_MOON_AMULET_COIN
	const EVENT_CINNABAR_SWIM_CHEAT
	const EVENT_BROCK_BACK_IN_GYM
	const EVENT_CINNABAR_ORDERED_STUFF
	const EVENT_CINNABAR_DELIVERED_STUFF
	const EVENT_CINNABAR_TOSSED_STUFF
	const EVENT_MR_ANTONS_HOUSE_RARE_CANDY
	const EVENT_POKEVACCINE_AVAILABLE
	const EVENT_CROWD_IN_VACCINATION_CENTER
	const EVENT_GOT_A_SHOT_TODAY

	const EVENT_FOUND_UP_GRADE
	const EVENT_GOT_POKEMON_FROM_SILPHCO
	const EVENT_PORYGON_POKEBALL_IN_SILPHCO
	const EVENT_FARFETCHD_POKEBALL_IN_SILPHCO
	const EVENT_MRMIME_POKEBALL_IN_SILPHCO
	...
	const EVENT_PEWTER_MUSEUM_ITEM_OLD_AMBER
	const EVENT_PEWTER_MUSEUM_RATTATA
	const EVENT_PEWTER_MUSEUM_HIDDEN_SILVER_WING

	const EVENT_CERULEAN_CAVE_B1F_TEXT_1
	const EVENT_CERULEAN_CAVE_B1F_TEXT_2
	const EVENT_CERULEAN_CAVE_B1F_TEXT_3
	const EVENT_CERULEAN_CAVE_B1F_TEXT_4

	const EVENT_CERULEAN_CAVE_B2F_TEXT_1
	...
	const EVENT_VOLCANO_FIRE_STONE

	const EVENT_BOULDER_IN_SEAFOAM_B1F_1
	const EVENT_BOULDER_IN_SEAFOAM_B1F_2
	const EVENT_BOULDER_IN_SEAFOAM_B2F_1
	const EVENT_BOULDER_IN_SEAFOAM_B2F_2
	const EVENT_BOULDER_IN_SEAFOAM_B2F_3
	const EVENT_BOULDER_IN_SEAFOAM_B2F_4
	const EVENT_BOULDER_IN_SEAFOAM_B3F_1
	const EVENT_BOULDER_IN_SEAFOAM_B3F_2
	const EVENT_BOULDER_IN_SEAFOAM_B3F_3
	const EVENT_BOULDER_IN_SEAFOAM_B4F_ALL
	const EVENT_BOULDER_IN_SEAFOAM_B5F_ALL
	...
	const EVENT_CONTACT_TRACING_NOTIFICATION_DISPLAY
	...
	const EVENT_BEAT_FISHER_WADE
	const EVENT_BEAT_FISHER_SKOVORODA
	const EVENT_BEAT_FISHER_MURPHY
	const EVENT_BEAT_SWIMMERM_ESTEBAN
	const EVENT_BEAT_SWIMMERM_TYSON
	const EVENT_BEAT_SWIMMERM_DUANE
	const EVENT_BEAT_BIRDKEEPER_GIDEON
	const EVENT_BEAT_BIRDKEEPER_EASTON
	const EVENT_BEAT_BIRDKEEPER_LEON

	const EVENT_DIGLETTS_CAVE_FOUGHT_PADRE_DUGTRIO
	const EVENT_DIGLETTS_CAVE_HIDDEN_STARDUST
	const EVENT_DIGLETTS_CAVE_GREAT_BALL
...
; Kurt Apricorn events
	...
	const EVENT_GAVE_KURT_APRICORN
; Phone events
...
; More Crystal-exclusive events in Johto
	...
	const EVENT_MART_LAVENDER_1_MISSED ; 1, THICK_CLUB, 4900
	const EVENT_MART_LAVENDER_2_MISSED ; 1, REVIVAL_HERB, 4000
	const EVENT_MART_CERULEAN_MISSED ; 1, CARBOS, 9800
	const EVENT_MART_FUCHSIA_MISSED ; 6, MOOMOO_MILK S, 6000

	const EVENT_MART_MTMOON_1_MISSED ; 1, SCOPE_LENS, 4900
	const EVENT_MART_MTMOON_2_MISSED ; 1, METAL_COAT, 4900
	const EVENT_MART_MTMOON_3_MISSED ; 3, MAX_ELIXER, 13500
	; End of mart items.

	const EVENT_WARDENS_NEIGHBOR_BOULDER_BLOCKING
	const EVENT_WARDENS_NEIGHBOR_BOULDER_CLEARED

	const EVENT_WARDENS_NEIGHBOR_AT_NEIGHBORS
...
; Burglar
	...
	const EVENT_BEAT_BURGLAR_BONES
; Biker
...
; SwimmerM
	...
	const EVENT_BEAT_SWIMMERM_FLAVIEN
...
; Added by Damien: Hospital trainers. 
	const EVENT_BEAT_HOSPITAL_TRAINER_CORRIDOR_1
	const EVENT_BEAT_HOSPITAL_TRAINER_CORRIDOR_2
	const EVENT_BEAT_HOSPITAL_TRAINER_ROOM_1
	const EVENT_BEAT_HOSPITAL_TRAINER_ROOM_3
	const EVENT_BEAT_HOSPITAL_TRAINER_ROOM_8
	const EVENT_BEAT_HOSPITAL_TRAINER_ROOM_17
	const EVENT_BEAT_HOSPITAL_TRAINER_ROOM_26
	const EVENT_BEAT_HOSPITAL_TRAINER_ROOM_30
	const EVENT_BEAT_HOSPITAL_TRAINER_ROOM_31
	const EVENT_BEAT_HOSPITAL_TRAINER_ROOM_32
	const EVENT_BEAT_HOSPITAL_CHIEF_NURSE ; Useless. Could use EVENT_FIRST_LOCKDOWN_STARTED.
; Hospital ball items.
	const EVENT_GOLDENROD_HOSPITAL_ITEM_ROOM_7
	const EVENT_GOLDENROD_HOSPITAL_ITEM_ROOM_15
; Hospital hidden items.
	const EVENT_GOLDENROD_HOSPITAL_ROOM_SUPER_POTION
	const EVENT_GOLDENROD_HOSPITAL_CORRIDOR_MAX_ELIXER
	const EVENT_GOLDENROD_1F_CORRIDOR_MAX_POTION

	const EVENT_SICK_GENTLEMAN_QUEST_ONGOING
	const EVENT_SICK_GENTLEMAN_DIED
	const EVENT_ANTONS_NURSE_DID_LONG_SPEECH
	const EVENT_PLAYER_CAN_GET_ITS_FIRST_SHOT
	...
	const EVENT_BEAT_BLACKBELT_ICARUS
	const EVENT_BEAT_HIKER_SAMMY
	const EVENT_BEAT_BIRD_KEEPER_BOBBY
	const EVENT_BEAT_BIKER_HUSQ
	const EVENT_BEAT_BUG_CATCHER_JEROME

	const EVENT_PLAYER_CAN_GET_ITS_SECOND_SHOT
	const EVENT_BEAT_COOLTRAINERM_FRED
	const EVENT_BEAT_COOLTRAINERF_MARIA

	const EVENT_ROCKET_THIEF_CERULEAN_CITY_GARDEN
	const EVENT_ROCKET_THIEF_ROUTE_4_SOUTH
	const EVENT_ROCKET_THIEF_ROUTE_4_NORTH
	const EVENT_ROCKET_THIEF_CAUGHT

	const EVENT_BEAT_BEAUTY_JOSIE
	const EVENT_BEAT_POKEFANM_FRANCIS

	const EVENT_BEAT_POKEFANF_CLEO1
	const EVENT_BEAT_POKEFANF_CLEO2
	const EVENT_CLEO_GAVE_VOUCHER

	const EVENT_LANAS_FURRET_GIVEN_TO_PLAYER
	...
	const EVENT_BEAT_BIKER_FEW
	const EVENT_BEAT_BIKER_MAUBE

; Unused: next 57 events	

	const_next 1592
	const EVENT_SICK_GENTLEMAN_FIRST_MEETING
	const EVENT_SICK_GENTLEMAN_THUNDER_STONE
	const EVENT_SICK_GENTLEMAN_RARE_CANDY
	const EVENT_SICK_GENTLEMAN_MAX_REVIVE
	const EVENT_SICK_GENTLEMAN_MAX_ETHER
	const EVENT_SICK_GENTLEMAN_FIRE_STONE
	const EVENT_SICK_GENTLEMAN_LEAF_STONE
	const EVENT_SICK_GENTLEMAN_WATER_STONE
...
; Johto people
	...
	const EVENT_CONSOLE_SELLER_BACK_IN_STORE
	const EVENT_ROUTE_34_ILEX_FOREST_GATE_LASS
	const EVENT_FETCH_RADIO_CARD
	...
	const EVENT_GOLDENROD_ILLEGAL_CASINO
	...
	const EVENT_ELMS_AIDE_IN_VIOLET
	const_skip
	...
	const EVENT_POKEMON_JUST_EVOLVED
	const_skip
	const_skip
	const_skip
	const_skip
	...
	const EVENT_TEAM_ROCKET_DISBANDED ; Never read, unused.
	...
	const EVENT_TINTOWER_SAGE_LEFT
	const EVENT_TINTOWER_SAGE_RIGHT
	...
	const_next 1900
; Kanto people
	const EVENT_CERULEAN_HOUSE_ROCKET
	...
	const_skip
	const EVENT_TRAIN_STATION_POPULATION
...
; New to Crystal
	...
	const EVENT_SICK_CATERPIE ; Useless. Could use EVENT_FIRST_LOCKDOWN_STARTED.
	const EVENT_BEAT_YOUAK
	const EVENT_GOT_MASTERBALL
	const EVENT_MET_OAK_IN_SAFFRON
	const EVENT_ANTI_SOFTLOCK_DELIVERY

	const EVENT_VIRIDIAN_FOREST_REVIVAL_HERB
	const EVENT_VIRIDIAN_FOREST_MIRACLE_SEED

	const EVENT_MOM_CALLED_ABOUT_VACCINATION_PASS
	const EVENT_ROUTE_24_HIDDEN_PP_UP
	const EVENT_ROUTE_24_HIDDEN_HP_UP
	const EVENT_ROUTE_24_HIDDEN_TOILET_PAPER

	const EVENT_BEAT_NUGGET_BRIDGE_CALE
	const EVENT_BEAT_NUGGET_BRIDGE_ALI
	const EVENT_BEAT_NUGGET_BRIDGE_TIMMY
	const EVENT_BEAT_NUGGET_BRIDGE_RELI
	const EVENT_BEAT_NUGGET_BRIDGE_KEVIN
	const EVENT_BEAT_NUGGET_BRIDGE_SHANE
	...
	const EVENT_GOT_COVID_ON_ROUTE_13
	const EVENT_GOT_COVID_ON_ROUTE_10
	const EVENT_GOT_COVID_ON_ROUTE_18
	const EVENT_GOT_COVID_ON_ROUTE_16

	const EVENT_AMPHY_BURIAL_CEREMONY_JUST_FINISHED
	const EVENT_JASMINE_AT_SOUL_HOUSE
	const EVENT_JASMINE_AT_FUJIS
	const EVENT_LORELEI_AT_SOUL_HOUSE
	const EVENT_SURGE_AT_SOUL_HOUSE

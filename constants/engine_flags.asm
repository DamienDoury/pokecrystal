...
; wPokegearFlags
	...
	const ENGINE_DISPLAY_YEAR_AT_START
...
; used to be wUnusedTwoDayTimerOn
	const_skip
; wStatusFlags
...
; wStatusFlags2
	...
	const ENGINE_WEARING_FACE_MASK
...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_ROCK_TUNNEL ; Not accessible during normal gameplay.
...
; wDailyFlags3
	const ENGINE_TOOK_DRINK_FROM_FRIDGE
	const ENGINE_PLAYER_SCARED_DAYCARE
	const ENGINE_SCALPER
	const ENGINE_OLIVINE_CAFE
	const ENGINE_FREE_EMERGENCY_POKEBALL_SENT
	const ENGINE_DAILY3_UNUSED_5
	const ENGINE_DAILY3_UNUSED_6
	const ENGINE_DAILY3_UNUSED_7
; wSwarmFlags
...
; wDailyRematchFlags
	...
	const ENGINE_CLEO_READY_FOR_REMATCH
	const ENGINE_DASH_READY_FOR_REMATCH
	const ENGINE_JODIE_READY_FOR_REMATCH

; MenuHeader flags
	...
	shift_const MENU_USE_BACKUP_AS_START_POS
...
; used by PokemonActionSubmenu (see engine/pokemon/mon_menu.asm)
	...
	const MONMENUITEM_MAIL       ; 19
	const MONMENUITEM_ERROR      ; 20
...
; PartyMenuQualityPointers indexes (see data/party_menu_qualities.asm)
	...
	const PARTYMENUACTION_COMBO_MENU ; Upgraded menu with mon selection and items in one menu.

...
MonMenuIconPals:
	...
	icon_pals BROWN, GRAY ; GEODUDE
	icon_pals BROWN, PINK ; GRAVELER
	...
	icon_pals PINK, RED ; GOLDEEN
	icon_pals RED, RED ; SEAKING
	...
	icon_pals RED, RED ; LEDYBA
	icon_pals RED, RED ; LEDIAN

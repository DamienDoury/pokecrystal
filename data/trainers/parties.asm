...
FalknerGroup:
	...
	db  49, PIDGEY,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db  52, PIDGEOTTO,  TACKLE, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 53, JIGGLYPUFF,   SING, BODY_SLAM, CHARM, SEISMIC_TOSS
	db 55, DITTO,   TRANSFORM, NO_MOVE, NO_MOVE, NO_MOVE
	db 55, LICKITUNG,   WRAP, DISABLE, LICK, BUBBLEBEAM
	db 55, CLEFAIRY,   MOONLIGHT, FIRE_PUNCH, THUNDERPUNCH, METRONOME
	db 55, CHANSEY,   SOFTBOILED, EGG_BOMB, MINIMIZE, DEFENSE_CURL
	db 59, MILTANK,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 50, LEDIAN,    COMET_PUNCH, LIGHT_SCREEN, SUPERSONIC, PSYBEAM
	db 52, ARIADOS,     SPIDER_WEB, POISON_STING, NIGHT_SHADE, LEECH_LIFE
...
MortyGroup:
	...
	db 59, GASTLY,     PROTECT, SPITE, MEAN_LOOK, CURSE
	db 62, HAUNTER,    TOXIC, DESTINY_BOND, CONFUSE_RAY, NIGHT_SHADE
	db 62, HAUNTER,    SPITE, PROTECT, DOUBLE_TEAM, CURSE
	db 64, GENGAR,     SHADOW_BALL, THUNDERBOLT, PSYCHIC_M, GIGA_DRAIN
	db 64, GENGAR,     HYPNOSIS, NIGHTMARE, CONFUSE_RAY, DREAM_EATER
	db 62, MISDREAVUS, PERISH_SONG, PSYCHIC_M, MEAN_LOOK, PROTECT
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 64, CLOYSTER,       SPIKES, SPIKE_CANNON, BARRIER, CLAMP
	db 67, LAPRAS,       PERISH_SONG, WHIRLPOOL, SING, PROTECT
	db 67, DEWGONG,    ICE_BEAM, WATERFALL, ATTRACT, ENCORE
	db 67, JYNX,    LOVELY_KISS, DREAM_EATER, PSYCH_UP, DYNAMICPUNCH
	db 67, DELIBIRD,    FLY, DETECT, SWAGGER, DOUBLE_TEAM
	db 70, PILOSWINE,  EARTHQUAKE, REST, SLEEP_TALK, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 66, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 66, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 70, STEELIX,    SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 63, PRIMEAPE,   FOCUS_ENERGY, CROSS_CHOP, THRASH, SEISMIC_TOSS
	db 65, PRIMEAPE,   THUNDERPUNCH, FIRE_PUNCH, ICE_PUNCH, KARATE_CHOP
	db 67, POLIWRATH,  BELLY_DRUM, WATERFALL, SUBMISSION, REST
	db 65, HERACROSS,  MEGAHORN, COUNTER, REVERSAL, ENDURE
	db 65, MACHOKE,  DOUBLE_TEAM, EARTHQUAKE, THIEF, RETURN
	db 65, MACHAMP,  DYNAMICPUNCH, VITAL_THROW, ROCK_SLIDE, CURSE
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_MOVES
	db 67, DRAGONAIR,  THUNDER_WAVE, SURF, SLAM, DRAGONBREATH
	db 67, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 67, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, SLAM, DRAGONBREATH
	db 70, KINGDRA,    SMOKESCREEN, SURF, HYPER_BEAM, DRAGONBREATH
	db -1 ; end

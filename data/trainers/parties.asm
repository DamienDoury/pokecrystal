...
SwatGroup:
	...
	db 50, FORRETRESS,		GOLD_BERRY, SPIKES, EXPLOSION, REFLECT, ROLLOUT
	db 50, ELECTRODE,		GOLD_BERRY, EXPLOSION, LIGHT_SCREEN, THUNDER, TOXIC
	db 50, VAPOREON,		GOLD_BERRY, WHIRLPOOL, ICE_BEAM, ACID_ARMOR, BATON_PASS
	db 50, ALAKAZAM,		TWISTEDSPOON, PSYCHIC_M, FUTURE_SIGHT, DISABLE, ENCORE
	db 50, GIRAFARIG,		GOLD_BERRY, AMNESIA, CURSE, AGILITY, BATON_PASS
	db 50, MISDREAVUS,		GOLD_BERRY, SHADOW_BALL, PERISH_SONG, PAIN_SPLIT, MEAN_LOOK
	db 50, GENGAR,			FOCUS_BAND, DESTINY_BOND, CURSE, ZAP_CANNON, MEAN_LOOK
	db 50, JUMPLUFF,		FOCUS_BAND, SLEEP_POWDER, LEECH_SEED, REFLECT, CONFUSION
	db 50, RHYHORN,			FOCUS_BAND, HORN_DRILL, EARTHQUAKE, ROCK_SLIDE, SCARY_FACE
	db 51, SNEASEL,			NO_ITEM, BEAT_UP, ICE_PUNCH, THIEF, METAL_CLAW
	db 51, MACHAMP,			SCOPE_LENS, CROSS_CHOP, EARTHQUAKE, FOCUS_ENERGY, CURSE
	db 51, KINGLER,			FOCUS_BAND, GUILLOTINE, CRABHAMMER, HAZE, SUBSTITUTE
	db 51, STEELIX,			LEFTOVERS, 	DIG, SANDSTORM, IRON_TAIL, PROTECT
	db 52, BLASTOISE,		GOLD_BERRY, HYDRO_PUMP, SKULL_BASH, BLIZZARD, ROLLOUT
	db 52, CHARIZARD,		BRIGHTPOWDER, FLAMETHROWER, DYNAMICPUNCH, ANCIENTPOWER, DRAGONBREATH
	db 52, VENUSAUR,		LEFTOVERS, 	LEECH_SEED, SLUDGE_BOMB, GIGA_DRAIN, SUBSTITUTE
	db 52, JOLTEON,			FOCUS_BAND, RAIN_DANCE, THUNDER, DOUBLE_KICK, SHADOW_BALL
	db 52, UMBREON,			LEFTOVERS, 	SCREECH, CONFUSE_RAY, FAINT_ATTACK, MOONLIGHT
	db 52, SNORLAX,			MINT_BERRY, CURSE, REST, AMNESIA, FIRE_PUNCH
	db 52, SNORLAX,			GOLD_BERRY, BELLY_DRUM, REST, ROLLOUT, ICE_PUNCH
	db 52, MUK,				LEFTOVERS, MINIMIZE, TOXIC, ACID_ARMOR, FIRE_PUNCH
	db 52, MUK,				LEFTOVERS, MINIMIZE, TOXIC, SUBSTITUTE, MEAN_LOOK
	db 52, HITMONCHAN,		LEFTOVERS, MACH_PUNCH, FIRE_PUNCH, ICE_PUNCH, THUNDERPUNCH
	db 53, BLISSEY,			LEFTOVERS, SOFTBOILED, MINIMIZE, CURSE, IRON_TAIL
	db 53, DITTO,			METAL_POWDER, TRANSFORM, NO_MOVE, NO_MOVE, NO_MOVE
	db 53, LAPRAS,			GOLD_BERRY, HAIL, BLIZZARD, SURF, SING
	db 53, PILOSWINE,		GOLD_BERRY, HAIL, BLIZZARD, EARTHQUAKE, ROCK_SLIDE
	db 53, DRAGONITE,		LEFTOVERS, FLY, EXTREMESPEED, FIRE_BLAST, OUTRAGE
	db 53, DRAGONITE,		LEFTOVERS, FLY, EXTREMESPEED, FIRE_PUNCH, OUTRAGE
	db 53, KINGDRA,			GOLD_BERRY, AGILITY, SURF, FLAIL, HIDDEN_POWER
	db 53, KINGDRA,			GOLD_BERRY, SUBSTITUTE, WATERFALL, DRAGONBREATH, ICE_BEAM

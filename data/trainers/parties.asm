...
JanineGroup:
	...
	db 80, NIDOQUEEN
	dw HALF_STAT_EXP, HALF_STAT_EXP, HALF_STAT_EXP, HALF_STAT_EXP, HALF_STAT_EXP
	db KINGS_ROCK, BEAT_UP, EARTHQUAKE, FOCUS_ENERGY, DYNAMIC_PUNCH
	...
	db 82, WEEZING
	dw HALF_STAT_EXP, HALF_STAT_EXP, HALF_STAT_EXP, HALF_STAT_EXP, HALF_STAT_EXP
	db MIRACLE_BERRY, DESTINY_BOND, PAIN_SPLIT, FIRE_BLAST, TOXIC
...
BlaineGroup:
	; BLAINE (1)
	db "BLAINE@", TRAINERTYPE_ITEM_MOVES | TRAINERTYPE_STAT_DVS | TRAINERTYPE_STAT_EXP
	db 84, MAGCARGO
	db PERFECT_DV, PERFECT_DV ; atk|def, spd|spc
	dw PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP, PERFECT_STAT_EXP

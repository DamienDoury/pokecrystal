...
SabrinaGroup:
	...
	db 76, ESPEON,     SAND_ATTACK, QUICK_ATTACK, SWIFT, PSYCHIC_M
	db 76, MR__MIME,   BARRIER, REFLECT, BATON_PASS, PSYCHIC_M
	db 78, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db -1 ; end

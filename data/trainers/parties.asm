...
BlueGroup:
	...
	db 80, PIDGEOT,    		GOLD_BERRY, QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	db 80, ALAKAZAM,   		GOLD_BERRY, DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db 80, RHYDON,     		GOLD_BERRY, FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 80, GYARADOS,   		GOLD_BERRY, TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db 80, EXEGGUTOR,  		GOLD_BERRY, SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLARBEAM
	db 80, ARCANINE,   		GOLD_BERRY, ROAR, SWIFT, FLAMETHROWER, EXTREMESPEED
	db 80, TAUROS,   		GOLD_BERRY, THRASH, PURSUIT, FIRE_BLAST, EARTHQUAKE
	db 80, MACHAMP,   		GOLD_BERRY, DYNAMICPUNCH, ICE_PUNCH, FIRE_PUNCH, EARTHQUAKE
	db 80, FORRETRESS,    	GOLD_BERRY, SPIKES, EXPLOSION, ROLLOUT, PIN_MISSILE
	db 80, SCIZOR,    		GOLD_BERRY, SWORDS_DANCE, METAL_CLAW, FURY_CUTTER, BATON_PASS
	db 80, TYRANITAR,  		GOLD_BERRY, SANDSTORM, CRUNCH, ROCK_SLIDE, FIRE_PUNCH
	db 80, TYRANITAR,  		GOLD_BERRY, SANDSTORM, CRUNCH, ROCK_SLIDE, EARTHQUAKE
	db 80, GENGAR,  		GOLD_BERRY, THUNDERBOLT, SHADOW_BALL, GIGA_DRAIN, PSYCHIC_M
	db 80, GENGAR,  		GOLD_BERRY, HYPNOSIS, NIGHTMARE, DREAM_EATER, MEAN_LOOK
	db 80, ELECTABUZZ,  	GOLD_BERRY, THUNDERPUNCH, FIRE_PUNCH, ICE_PUNCH, CROSS_CHOP
	db 80, ELECTABUZZ,  	GOLD_BERRY, DIZZY_PUNCH, ZAP_CANNON, LIGHT_SCREEN, ICE_PUNCH
	db 80, SNEASEL,  		GOLD_BERRY, BEAT_UP, BLIZZARD, SLASH, DYNAMICPUNCH
	db 80, SNEASEL,  		GOLD_BERRY, BEAT_UP, METAL_CLAW, SCREECH, ICE_PUNCH
	db 80, TENTACRUEL,  	GOLD_BERRY, BARRIER, BUBBLEBEAM, SLUDGE_BOMB, REST
	db 80, TENTACRUEL,  	GOLD_BERRY, TOXIC, WHIRLPOOL, SLUDGE_BOMB, ICE_BEAM
	db 80, KINGDRA,  		GOLD_BERRY, OCTAZOOKA, DRAGONBREATH, DISABLE, RAIN_DANCE
	db 80, KINGDRA,  		GOLD_BERRY, HYDRO_PUMP, REST, WHIRLPOOL, SUBSTITUTE
	db 80, HERACROSS,  		GOLD_BERRY, MEGAHORN, COUNTER, REVERSAL, SWAGGER
	db 80, MUK,  			GOLD_BERRY, SLUDGE_BOMB, MINIMIZE, REST, ACID_ARMOR
	db 80, MUK,  			GOLD_BERRY, SLUDGE_BOMB, MINIMIZE, REST, FIRE_BLAST
	db 80, NIDOQUEEN,  		GOLD_BERRY, SURF, EARTHQUAKE, SHADOW_BALL, FIRE_BLAST
	db 80, NIDOQUEEN,  		GOLD_BERRY, ROAR, EARTHQUAKE, SURF, THUNDERPUNCH
	db 80, HOUNDOOM,  		GOLD_BERRY, SLUDGE_BOMB, FIRE_BLAST, CRUNCH, FIRE_SPIN
	db 80, AERODACTYL,  	GOLD_BERRY, ROCK_SLIDE, EARTHQUAKE, CRUNCH, IRON_TAIL
	db 80, AERODACTYL,  	GOLD_BERRY, ROCK_SLIDE, EARTHQUAKE, FLY, SANDSTORM
	db -1 ; end

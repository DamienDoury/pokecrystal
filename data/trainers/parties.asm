...
SergeantGroup:
	...
	db 29, GRANBULL,		BERRY, ICE_PUNCH, THUNDERPUNCH, FIRE_PUNCH, REFLECT
	db 29, GRANBULL,		BERRY, ICE_PUNCH, THUNDERPUNCH, FIRE_PUNCH, REFLECT
	...
	db 27, MR__MIME,		BERRY, REFLECT, LIGHT_SCREEN, CONFUSION, SUBSTITUTE
	db 31, DONPHAN,			BERRY, DEFENSE_CURL, ROLLOUT, EARTHQUAKE, WATER_GUN
	db 31, DONPHAN,			BERRY, DEFENSE_CURL, ROLLOUT, MUD_SLAP, SWAGGER
	db 29, NINETALES,		CHARCOAL, FLAMETHROWER, SPITE, HIDDEN_POWER, HYPNOSIS
	db 29, NINETALES,		BERRY, FLAMETHROWER, SPITE, DIG, FAINT_ATTACK
	db 29, HOUNDOOM,		CHARCOAL, FLAMETHROWER, SOLARBEAM, CRUNCH, SUNNY_DAY
	db 29, HOUNDOOM,		BERRY, FLAMETHROWER, SUBSTITUTE, SOLARBEAM, SUNNY_DAY
	db 29, GRANBULL,		BERRY, REST, SNORE, HYPER_BEAM, SLUDGE_BOMB
	db 29, GRANBULL,		BERRY, METRONOME, THUNDERPUNCH, SLUDGE_BOMB, RETURN
	...
	db 29, GRANBULL,		BERRY, CRUNCH, HEADBUTT, ROAR, ROCK_SMASH
	db 29, GRANBULL,		NO_ITEM, THIEF, BITE, HEAL_BELL, TAKE_DOWN
	db 29, HOUNDOOM,		BERRY, FLAMETHROWER, BEAT_UP, HIDDEN_POWER, TOXIC
	db 29, HOUNDOOM,		NO_ITEM, FLAMETHROWER, SHADOW_BALL, THIEF, SLUDGE_BOMB
	db 29, ARCANINE,		BERRY, EXTREMESPEED, REST, DRAGONBREATH, SWIFT
	db 29, ARCANINE,		CHARCOAL, EXTREMESPEED, HYPER_BEAM, SUNNY_DAY, FIRE_BLAST
	db 29, NINETALES,		CHARCOAL, FLAMETHROWER, SUNNY_DAY, HIDDEN_POWER, HYPNOSIS
	db 29, NINETALES,		BERRY, FLAMETHROWER, DISABLE, DIG, RETURN
	db 29, NIDORINA,		GOLD_BERRY, FLAMETHROWER, ICE_BEAM, BUBBLEBEAM, HORN_DRILL
	db -1 ; end

...
SergeantGroup:
	...
	db 16, GROWLITHE,		CHARCOAL, EMBER, CRUNCH, ROAR, HEADBUTT
	db 16, GROWLITHE,		BERRY, EMBER, BITE, ROAR, BODY_SLAM
	db 16, VULPIX,			CHARCOAL, ATTRACT, CONFUSE_RAY, SAFEGUARD, EMBER
	db 16, VULPIX,			BERRY, ATTRACT, CONFUSE_RAY, FAINT_ATTACK, EMBER
	db 19, GRANBULL,		BERRY, ICE_PUNCH, THUNDERPUNCH, FIRE_PUNCH, REFLECT
	db 19, GRANBULL,		BERRY, ICE_PUNCH, THUNDERPUNCH, FIRE_PUNCH, REFLECT
	db 17, PINSIR,			BERRY, VICEGRIP, FOCUS_ENERGY, SEISMIC_TOSS, FURY_CUTTER
	db 17, SCYTHER,			BERRY, QUICK_ATTACK, FOCUS_ENERGY, PURSUIT, FURY_CUTTER
	db 17, MR__MIME,		BERRY, REFLECT, LIGHT_SCREEN, CONFUSION, SUBSTITUTE
	db 17, MR__MIME,		BERRY, REFLECT, LIGHT_SCREEN, CONFUSION, SUBSTITUTE
	db 20, DONPHAN,			BERRY, DEFENSE_CURL, ROLLOUT, EARTHQUAKE, WATER_GUN
	db 20, DONPHAN,			BERRY, DEFENSE_CURL, ROLLOUT, MUD_SLAP, SWAGGER
	db 19, NINETALES,		CHARCOAL, FLAMETHROWER, SPITE, HIDDEN_POWER, HYPNOSIS
	db 19, NINETALES,		BERRY, FLAMETHROWER, SPITE, DIG, FAINT_ATTACK
	db 19, HOUNDOOM,		CHARCOAL, FLAMETHROWER, SOLARBEAM, CRUNCH, SUNNY_DAY
	db 19, HOUNDOOM,		BERRY, FLAMETHROWER, SUBSTITUTE, SOLARBEAM, SUNNY_DAY
	db 19, GRANBULL,		BERRY, REST, SNORE, HYPER_BEAM, SLUDGE_BOMB
	db 19, GRANBULL,		BERRY, METRONOME, THUNDERPUNCH, SLUDGE_BOMB, RETURN
	db 16, NIDORINO,		BERRY, SWEET_KISS, RETURN, DOUBLE_KICK, POISON_STING
	db 16, NIDORINO,		BERRY, LOVELY_KISS, HORN_ATTACK, THUNDERBOLT, IRON_TAIL
	db 17, MANTINE,			BERRY, BUBBLEBEAM, TWISTER, REST, SLEEP_TALK
	db 17, MANTINE,			BERRY, BUBBLEBEAM, WING_ATTACK, ICY_WIND, AGILITY
	db 19, GRANBULL,		BERRY, CRUNCH, HEADBUTT, ROAR, ROCK_SMASH
	db 19, GRANBULL,		NO_ITEM, THIEF, BITE, HEAL_BELL, TAKE_DOWN
	db 19, HOUNDOOM,		BERRY, FLAMETHROWER, BEAT_UP, HIDDEN_POWER, TOXIC
	db 19, HOUNDOOM,		NO_ITEM, FLAMETHROWER, SHADOW_BALL, THIEF, SLUDGE_BOMB
	db 19, ARCANINE,		BERRY, EXTREMESPEED, REST, DRAGONBREATH, SWIFT
	db 19, ARCANINE,		CHARCOAL, EXTREMESPEED, HYPER_BEAM, SUNNY_DAY, FIRE_BLAST
	db 19, NINETALES,		CHARCOAL, FLAMETHROWER, SUNNY_DAY, HIDDEN_POWER, HYPNOSIS
	db 19, NINETALES,		BERRY, FLAMETHROWER, DISABLE, DIG, RETURN
	db 19, NIDORINA,		GOLD_BERRY, FLAMETHROWER, ICE_BEAM, BUBBLEBEAM, HORN_DRILL
	db -1 ; end

JennyGroup:
	; OFFICER (1)
	db "JENNY@", TRAINERTYPE_ITEM_MOVES
	db 30, GROWLITHE,		GOLD_BERRY, EMBER, BITE, ROAR, HEADBUTT
	db 30, GRANBULL,		GOLD_BERRY, METRONOME, HEAL_BELL, CRUNCH, CHARM
	db 30, ARCANINE,		GOLD_BERRY, EXTREMESPEED, FLAME_WHEEL, CURSE, CRUNCH
	db 30, ARCANINE,		GOLD_BERRY, FIRE_BLAST, SUNNY_DAY, ATTRACT, HYPER_BEAM
	db 30, WOBBUFFET,		GOLD_BERRY, COUNTER, MIRROR_COAT, SAFEGUARD, DESTINY_BOND
	db 30, GRANBULL,		GOLD_BERRY, DYNAMICPUNCH, ZAP_CANNON, FAINT_ATTACK, FIRE_PUNCH
	db 30, ARCANINE,		GOLD_BERRY, DOUBLE_TEAM, FLAMETHROWER, DRAGONBREATH, REST
	db 30, ARCANINE,		GOLD_BERRY, DIG, CRUNCH, ROAR, FIRE_BLAST
	db 31, OCTILLERY,		SCOPE_LENS, OCTAZOOKA, ICE_BEAM, FOCUS_ENERGY, MUD_SLAP
	db 31, OCTILLERY,		GOLD_BERRY, HAZE, PSYBEAM, BUBBLEBEAM, FLAMETHROWER
	db 31, QWILFISH,		GOLD_BERRY, SPIKES, PIN_MISSILE, MINIMIZE, FLAIL
	db 31, QWILFISH,		GOLD_BERRY, SPIKES, HYDRO_PUMP, TOXIC, ICY_WIND
	db 31, ARIADOS,			GOLD_BERRY, BATON_PASS, AGILITY, CURSE, NIGHT_SHADE
	db 31, ARIADOS,			GOLD_BERRY, SPIDER_WEB, DOUBLE_TEAM, LEECH_LIFE, SLUDGE_BOMB
	db 32, PIDGEOT,			GOLD_BERRY, FLY, FAINT_ATTACK, MIMIC, STEEL_WING
	db 32, PIDGEOT,			GOLD_BERRY, SKY_ATTACK, SUBSTITUTE, QUICK_ATTACK, SAND_ATTACK
	db 32, TANGELA,			GOLD_BERRY, BIND, GIGA_DRAIN, POISONPOWDER, SWAGGER
	db 32, AZUMARILL,		GOLD_BERRY, DYNAMICPUNCH, ROLLOUT, WATERFALL, BELLY_DRUM
	db 32, AZUMARILL,		GOLD_BERRY, DEFENSE_CURL, AMNESIA, WHIRLPOOL, PERISH_SONG
	db 33, PARASECT,		GOLD_BERRY, LEECH_LIFE, SWORDS_DANCE, SPORE, SUBSTITUTE
	db 33, PARASECT,		GOLD_BERRY, GIGA_DRAIN, STUN_SPORE, GROWTH, SLASH
	db 33, JUMPLUFF,		GOLD_BERRY, ENCORE, LEECH_SEED, GIGA_DRAIN, HEADBUTT
	db 33, JUMPLUFF,		GOLD_BERRY, SLEEP_POWDER, LEECH_SEED, SUNNY_DAY, SOLARBEAM
	db 33, HAUNTER,			NO_ITEM, THIEF, NIGHT_SHADE, PERISH_SONG, THUNDER
	db 33, HAUNTER,			GOLD_BERRY, HYPNOSIS, CURSE, DREAM_EATER, SHADOW_BALL
	db 34, SQUIRTLE,		GOLD_BERRY, HYDRO_PUMP, SKULL_BASH, RAPID_SPIN, ATTRACT
	db 34, SQUIRTLE,		GOLD_BERRY, HYDRO_PUMP, SKULL_BASH, DEFENSE_CURL, ROLLOUT
	db 34, MEGANIUM,		GOLD_BERRY, SUNNY_DAY, SOLARBEAM, SYNTHESIS, SAFEGUARD
	db 34, MEGANIUM,		GOLD_BERRY, RAZOR_LEAF, SWORDS_DANCE, LEECH_SEED, LIGHT_SCREEN
	db 34, CROCONAW,		GOLD_BERRY, CRUNCH, ROCK_SLIDE, SUBMISSION, FURY_CUTTER
	db 34, CROCONAW,		GOLD_BERRY, RETURN, DIG, SURF, ANCIENTPOWER
	db -1 ; end

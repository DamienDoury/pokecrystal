...
SergeantGroup:
	...
	db 28, GROWLITHE,		BERRY, EMBER, BITE, ROAR, HEADBUTT
	db 28, GROWLITHE,		BERRY, EMBER, BITE, ROAR, HEADBUTT
	db 28, GROWLITHE,		BERRY, EMBER, BITE, ROAR, HEADBUTT
	db 28, GROWLITHE,		BERRY, EMBER, BITE, ROAR, HEADBUTT
	db 28, GROWLITHE,		BERRY, EMBER, BITE, ROAR, HEADBUTT
...
JennyGroup:
	...
	db 40, OCTILLERY,		SCOPE_LENS, OCTAZOOKA, ICE_BEAM, FOCUS_ENERGY, MUD_SLAP
	db 40, OCTILLERY,		GOLD_BERRY, HAZE, PSYBEAM, BUBBLEBEAM, FLAMETHROWER
	db 40, ARIADOS,			GOLD_BERRY, BATON_PASS, AGILITY, CURSE, NIGHT_SHADE
	db 40, ARIADOS,			GOLD_BERRY, SPIDER_WEB, DOUBLE_TEAM, LEECH_LIFE, SLUDGE_BOMB
	...
	db 40, PARASECT,		GOLD_BERRY, LEECH_LIFE, SWORDS_DANCE, SPORE, SUBSTITUTE
	db 40, PARASECT,		GOLD_BERRY, GIGA_DRAIN, STUN_SPORE, GROWTH, SLASH
	db 40, JUMPLUFF,		GOLD_BERRY, ENCORE, LEECH_SEED, GIGA_DRAIN, HEADBUTT
	db 40, JUMPLUFF,		GOLD_BERRY, SLEEP_POWDER, LEECH_SEED, SUNNY_DAY, SOLARBEAM
	db 40, HAUNTER,			NO_ITEM, THIEF, NIGHT_SHADE, PERISH_SONG, THUNDER
	db 40, HAUNTER,			GOLD_BERRY, HYPNOSIS, CURSE, DREAM_EATER, SHADOW_BALL
	...
	db 40, QWILFISH,		GOLD_BERRY, SPIKES, PIN_MISSILE, MINIMIZE, FLAIL

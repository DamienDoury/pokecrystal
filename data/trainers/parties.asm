...
YoungsterGroup:
	...
	db 33, RATICATE, PERISH_SONG, MEAN_LOOK, PROTECT, WATER_GUN
	db 33, MISDREAVUS, PERISH_SONG, MEAN_LOOK, PROTECT, QUICK_ATTACK
	db 33, ARBOK, PERISH_SONG, FIRE_SPIN, PROTECT, QUICK_ATTACK
	db 33, ARBOK, PERISH_SONG, FIRE_SPIN, PROTECT, QUICK_ATTACK
	db -1 ; end

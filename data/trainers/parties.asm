...
FalknerGroup:
	...
	db  50, PIDGEOTTO,  BRIGHTPOWDER, FLY, SAND_ATTACK, DOUBLE_TEAM, PURSUIT
	db  52, FARFETCH_D, STICK, SLASH, SWORDS_DANCE, AGILITY, MIRROR_MOVE
	db  53, NOCTOWL,  	QUICK_CLAW, HYPNOSIS, DREAM_EATER, NIGHTMARE, NIGHT_SHADE
	db  54, SKARMORY,  	LEFTOVERS, DRILL_PECK, RETURN, STEEL_WING, SANDSTORM
	db  55, GLIGAR,  	NO_ITEM, SLUDGE_BOMB, THIEF, PROTECT, GUILLOTINE
	db  56, PIDGEOT,  	GOLD_BERRY, QUICK_ATTACK, SWAGGER, MIMIC, SKY_ATTACK
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_ITEM_MOVES
	db 53, JIGGLYPUFF,  QUICK_CLAW, SING, BODY_SLAM, CHARM, SEISMIC_TOSS
	db 55, DITTO,   	METAL_POWDER, TRANSFORM, NO_MOVE, NO_MOVE, NO_MOVE
	db 55, LICKITUNG,   LEFTOVERS, WRAP, DISABLE, LICK, BUBBLEBEAM
	db 55, CLEFAIRY,   	FOCUS_BAND, MOONLIGHT, FIRE_PUNCH, THUNDERPUNCH, METRONOME
	db 55, CHANSEY,   	BRIGHTPOWDER, SOFTBOILED, EGG_BOMB, MINIMIZE, DEFENSE_CURL
	db 59, MILTANK,    	GOLD_BERRY, ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_ITEM_MOVES
	db 50, LEDIAN,   	FOCUS_BAND, COMET_PUNCH, LIGHT_SCREEN, SUPERSONIC, PSYBEAM
	db 52, ARIADOS,     SILVERPOWDER, SPIDER_WEB, POISON_STING, NIGHT_SHADE, LEECH_LIFE
	db 52, BEEDRILL,    KINGS_ROCK, RAGE, TWINEEDLE, PURSUIT, FOCUS_ENERGY
	db 52, SHUCKLE,     GOLD_BERRY, ROCK_THROW, WRAP, SAFEGUARD, PROTECT
	db 52, YANMA,     	FOCUS_BAND, QUICK_ATTACK, SONICBOOM, WING_ATTACK, REVERSAL
	db 56, SCYTHER,    	SCOPE_LENS, SWORDS_DANCE, BATON_PASS, FURY_CUTTER, NO_MOVE
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_ITEM_MOVES
	db 59, GASTLY,     GOLD_BERRY, PROTECT, SPITE, MEAN_LOOK, CURSE
	db 62, HAUNTER,    FOCUS_BAND, TOXIC, DESTINY_BOND, CONFUSE_RAY, NIGHT_SHADE
	db 62, HAUNTER,    BRIGHTPOWDER, SPITE, PROTECT, DOUBLE_TEAM, CURSE
	db 64, GENGAR,     QUICK_CLAW, SHADOW_BALL, THUNDERBOLT, PSYCHIC_M, GIGA_DRAIN
	db 64, GENGAR,     MIRACLEBERRY, HYPNOSIS, NIGHTMARE, CONFUSE_RAY, DREAM_EATER
	db 62, MISDREAVUS, GOLD_BERRY, PERISH_SONG, PSYCHIC_M, MEAN_LOOK, PROTECT
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_ITEM_MOVES
	db 64, CLOYSTER,    FOCUS_BAND, SPIKES, SPIKE_CANNON, BARRIER, CLAMP
	db 67, LAPRAS,     	SMOKE_BALL, PERISH_SONG, WHIRLPOOL, SING, PROTECT
	db 67, DEWGONG,    	GOLD_BERRY, ICE_BEAM, WATERFALL, ATTRACT, ENCORE
	db 67, JYNX,    	GOLD_BERRY, LOVELY_KISS, DREAM_EATER, PSYCH_UP, DYNAMICPUNCH
	db 67, DELIBIRD,    BRIGHTPOWDER, FLY, DETECT, SWAGGER, DOUBLE_TEAM
	db 70, PILOSWINE,  	MIRACLEBERRY, EARTHQUAKE, REST, SLEEP_TALK, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_ITEM_MOVES
	db 65, FORRETRESS,  PINK_BOW, SPIKES, REFLECT, EXPLOSION, SANDSTORM
	db 68, FORRETRESS,  LEFTOVERS, SUBSTITUTE, ROLLOUT, SANDSTORM, NO_MOVE
	db 68, MAGNETON,  	MYSTERYBERRY, LOCK_ON, ZAP_CANNON, HIDDEN_POWER, SUPERSONIC
	db 70, SKARMORY,    SHARP_BEAK, SANDSTORM, FLY, TOXIC, WHIRLWIND
	db 70, SCIZOR,    	BRIGHTPOWDER, STEEL_WING, SWORDS_DANCE, WING_ATTACK, DOUBLE_TEAM
	db 72, STEELIX,    	GOLD_BERRY, CURSE, EARTHQUAKE, ROCK_SLIDE, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_ITEM_MOVES
	db 65, PRIMEAPE,   	SCOPE_LENS, FOCUS_ENERGY, CROSS_CHOP, THRASH, SEISMIC_TOSS
	db 67, PRIMEAPE,   	KINGS_ROCK, THUNDERPUNCH, FIRE_PUNCH, ICE_PUNCH, KARATE_CHOP
	db 67, HERACROSS,  	FOCUS_BAND, MEGAHORN, COUNTER, REVERSAL, ENDURE
	db 67, MACHOKE,  	NO_ITEM, DOUBLE_TEAM, EARTHQUAKE, THIEF, RETURN
	db 70, MACHAMP,  	BLACKBELT_I, DYNAMICPUNCH, VITAL_THROW, ROCK_SLIDE, CURSE
	db 70, POLIWRATH,  	MINT_BERRY, BELLY_DRUM, WATERFALL, SUBMISSION, REST
	db -1 ; end

ClairGroup:
	; CLAIR (1)
	db "CLAIR@", TRAINERTYPE_ITEM_MOVES
	db 67, DRATINI,  	FOCUS_BAND, EXTREMESPEED, OUTRAGE, BUBBLEBEAM, NO_MOVE
	db 70, DRAGONAIR,  	GOLD_BERRY, DRAGONBREATH, WATERFALL, ZAP_CANNON, THUNDER
	db 70, DRAGONAIR,  	GOLD_BERRY, BLIZZARD, SURF, IRON_TAIL, RETURN
	db 70, DRAGONAIR,  	GOLD_BERRY, FIRE_BLAST, ICY_WIND, HIDDEN_POWER, HEADBUTT
	db 72, DRAGONITE,  	BITTER_BERRY, EXTREMESPEED, OUTRAGE, ICE_PUNCH, THUNDERPUNCH
	db 75, KINGDRA,    	BRIGHTPOWDER, WHIRLPOOL, OCTAZOOKA, DRAGONBREATH, ICE_BEAM
	db -1 ; end
...
BrockGroup:
	...
	db 72, GOLEM,   EARTHQUAKE, EXPLOSION, DEFENSE_CURL, ROLLOUT
	db 72, AERODACTYL,    WHIRLWIND, FLY, PURSUIT, STEEL_WING
	db 72, OMASTAR,    ANCIENTPOWER, BITE, PROTECT, HYDRO_PUMP
	db 72, KABUTOPS,   ANCIENTPOWER, WHIRLPOOL, SLASH, GIGA_DRAIN
	db 75, TYRANITAR,   CRUNCH, ROCK_SLIDE, EARTHQUAKE, OUTRAGE
	db 75, ONIX,       BIND, ROCK_SLIDE, BIDE, SANDSTORM
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 72, TENTACRUEL,   SUBSTITUTE, WRAP, SLUDGE_BOMB, GIGA_DRAIN
	db 72, GOLDUCK,    SURF, DISABLE, DYNAMICPUNCH, PSYCHIC_M
	db 72, DEWGONG,     SURF, ICE_BEAM, SAFEGUARD, HEADBUTT
	db 72, LANTURN,    ZAP_CANNON, HYDRO_PUMP, REST, SLEEP_TALK
	db 75, BLASTOISE,   MIRROR_COAT, SKULL_BASH, ICE_PUNCH, HYDRO_PUMP
	db 75, STARMIE,    THUNDER, PSYCHIC_M, RAPID_SPIN, SURF
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 72, ELECTRODE,  LIGHT_SCREEN, RAIN_DANCE, THUNDER, EXPLOSION
	db 72, ELECTRODE,  REFLECT, ROLLOUT, DOUBLE_TEAM, EXPLOSION
	db 72, MAGNETON,   LOCK_ON, DOUBLE_TEAM, SWAGGER, ZAP_CANNON
	db 72, JOLTEON,  DOUBLE_KICK, PIN_MISSILE, MIMIC, THUNDERBOLT
	db 72, ELECTABUZZ, FIRE_PUNCH, THUNDERPUNCH, ICE_PUNCH, CROSS_CHOP
	db 75, RAICHU,     DIZZY_PUNCH, THUNDERBOLT, THUNDER, PETAL_DANCE
	db -1 ; end
...
JanineGroup:
	...
	db 76, CROBAT,     SCREECH, CONFUSE_RAY, STEEL_WING, FLY
	db 76, WEEZING,    SLUDGE_BOMB, THIEF, FIRE_BLAST, EXPLOSION
	db 76, WEEZING,    SLUDGE_BOMB, THIEF, THUNDER, EXPLOSION
	db 73, ARIADOS,    TOXIC, GIGA_DRAIN, NIGHT_SHADE, SPIDER_WEB
	db 79, VENOMOTH,   DOUBLE_TEAM, GUST, PSYCHIC_M, TOXIC
	db -1 ; end
...
BlaineGroup:
	...
	db 80, RAPIDASH,   QUICK_ATTACK, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db -1 ; end

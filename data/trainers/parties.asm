...
FalknerGroup:
	...
	db  39, PIDGEY,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db  42, PIDGEOTTO,  TACKLE, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 48, CLEFAIRY,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 53, MILTANK,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 46, METAPOD,    TACKLE, STRING_SHOT, HARDEN, NO_MOVE
	db 46, KAKUNA,     POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
	db 48, SCYTHER,    QUICK_ATTACK, LEER, FURY_CUTTER, NO_MOVE
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 51, GASTLY,     LICK, SPITE, MEAN_LOOK, CURSE
	db 51, HAUNTER,    HYPNOSIS, MIMIC, CURSE, NIGHT_SHADE
	db 55, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 53, HAUNTER,    SPITE, MEAN_LOOK, MIMIC, NIGHT_SHADE
	db -1 ; end

PryceGroup:
	; PRYCE (1)
	db "PRYCE@", TRAINERTYPE_MOVES
	db 57, SEEL,       HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 59, DEWGONG,    HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 61, PILOSWINE,  ICY_WIND, FURY_ATTACK, MIST, BLIZZARD
	db -1 ; end

JasmineGroup:
	; JASMINE (1)
	db "JASMINE@", TRAINERTYPE_MOVES
	db 60, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 60, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 65, STEELIX,    SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 59, PRIMEAPE,   LEER, RAGE, KARATE_CHOP, FURY_SWIPES
	db 65, POLIWRATH,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
...
BrockGroup:
	...
	db 71, GRAVELER,   DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 71, RHYHORN,    FURY_ATTACK, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 72, OMASTAR,    BITE, SURF, PROTECT, SPIKE_CANNON
	db 74, ONIX,       BIND, ROCK_SLIDE, BIDE, SANDSTORM
	db 72, KABUTOPS,   SLASH, SURF, ENDURE, GIGA_DRAIN
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 72, GOLDUCK,    SURF, DISABLE, PSYCH_UP, PSYCHIC_M
	db 72, QUAGSIRE,   SURF, AMNESIA, EARTHQUAKE, RAIN_DANCE
	db 74, LAPRAS,     SURF, PERISH_SONG, BLIZZARD, RAIN_DANCE
	db 77, STARMIE,    SURF, CONFUSE_RAY, RECOVER, ICE_BEAM
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 74, RAICHU,     QUICK_ATTACK, THUNDERBOLT, THUNDER, SWIFT
	db 70, ELECTRODE,  SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
	db 70, MAGNETON,   LOCK_ON, DOUBLE_TEAM, SWIFT, ZAP_CANNON
	db 70, ELECTRODE,  SCREECH, DOUBLE_TEAM, SWIFT, EXPLOSION
	db 76, ELECTABUZZ, QUICK_ATTACK, THUNDERPUNCH, LIGHT_SCREEN, THUNDER
	db -1 ; end

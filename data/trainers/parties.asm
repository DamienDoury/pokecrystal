...
JanineGroup:
	...
	db 76, CROBAT,     SCREECH, SUPERSONIC, CONFUSE_RAY, WING_ATTACK
	db 76, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 76, WEEZING,    SMOG, SLUDGE_BOMB, TOXIC, EXPLOSION
	db 73, ARIADOS,    SCARY_FACE, GIGA_DRAIN, STRING_SHOT, NIGHT_SHADE
	db 79, VENOMOTH,   FORESIGHT, DOUBLE_TEAM, GUST, PSYCHIC_M
	db -1 ; end

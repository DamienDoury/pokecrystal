...
MortyGroup:
	...
	db 62, HAUNTER,    TOXIK, DESTINY_BOND, CONFUSE_RAY, NIGHT_SHADE
...
PryceGroup:
	...
	db 67, JYNX,    LOVELY_KISS, DREAM_EATER, PSYCH_UP, DYNAMIC_PUNCH
...
ChuckGroup:
	...
	db 65, MACHAMP,  DYNAMIC_PUNCH, VITAL_THROW, ROCK_SLIDE, CURSE
	db -1 ; end
...
BrockGroup:
	...
	db 72, OMASTAR,    ANCIENT_POWER, BITE, PROTECT, HYDROPUMP
	db 72, KABUTOPS,   ANCIENT_POWER, WHIRLPOOL, SLASH, GIGA_DRAIN
...
MistyGroup:
	...
	db 75, BLASTOISE,   COUNTER, SKULL_BASH, ICE_PUNCH, HYDRO_PUMP

	...
	tilecoll WALL, WALL, WALL, CLOSED_DOOR ; 09
	...
	tilecoll FLOOR, FLOOR, FLOOR, WARP_CARPET_DOWN ; 74
	tilecoll WALL, WALL, WALL, WALL ; 75
	tilecoll WALL, WALL, CLOSED_DOOR, WALL ; 76

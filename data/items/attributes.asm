DEF BIG_ROOT_REGEN_VALUE EQU 5
...
; BRIGHTPOWDER
	item_attribute 10, HELD_PASSIVE, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; GREAT_BALL
...
; TOWN_MAP
	item_attribute $9999, HELD_NONE, 0, CANT_SELECT | NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BICYCLE
...
; ANTIDOTE
	item_attribute 100, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; BURN_HEAL
	item_attribute 250, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; ICE_HEAL
	item_attribute 250, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; AWAKENING
	item_attribute 250, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; PARLYZ_HEAL
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; FULL_RESTORE
	item_attribute 3000, HELD_NONE, -1, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; MAX_POTION
	item_attribute 2500, HELD_NONE, -1, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; HYPER_POTION
	item_attribute 1200, HELD_NONE, 120, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; SUPER_POTION
	item_attribute 700, HELD_NONE, 60, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; POTION
	item_attribute 300, HELD_NONE, 20, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; ESCAPE_ROPE
...
; MAX_ELIXER
	item_attribute 4500, HELD_NONE, -1, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; FIRE_STONE
...
; WATER_STONE
	item_attribute 2100, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ITEM_19
	item_attribute 0, HELD_NONE, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; HP_UP
	item_attribute 9800, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_NOUSE
; PROTEIN
	item_attribute 9800, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_NOUSE
; IRON
	item_attribute 9800, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_NOUSE
; CARBOS
	item_attribute 9800, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_NOUSE
; LUCKY_PUNCH
	item_attribute 10, HELD_PASSIVE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CALCIUM
	item_attribute 9800, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_NOUSE
; RARE_CANDY
	item_attribute 4800, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_NOUSE
; X_ACCURACY
...
; FULL_HEAL
	item_attribute 600, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; REVIVE
	item_attribute 1500, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; MAX_REVIVE
	item_attribute 4000, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; GUARD_SPEC
...
; ITEM_2D
	item_attribute $9999, HELD_NONE, 0, CANT_SELECT | NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FRESH_WATER
	item_attribute 200, HELD_NONE, 30, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; SODA_POP
	item_attribute 300, HELD_NONE, 50, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; LEMONADE
	item_attribute 350, HELD_NONE, 70, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; X_ATTACK
	item_attribute 500, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_CLOSE
; JADE_CRYSTAL
	item_attribute 999, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; X_DEFEND
...
; POKE_FLUTE
	item_attribute $9999, HELD_NONE, 0, CANT_SELECT | NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; EXP_SHARE
	item_attribute 3000, HELD_PASSIVE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; OLD_ROD
...
; PP_UP
	item_attribute 9800, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ETHER
	item_attribute 1200, HELD_NONE, 10, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; MAX_ETHER
	item_attribute 2000, HELD_NONE, -1, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; ELIXER
	item_attribute 3000, HELD_NONE, 10, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; RED_SCALE
...
; SILVER_WING
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; MOOMOO_MILK
	item_attribute 500, HELD_NONE, 100, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; QUICK_CLAW
...
; STICK
	item_attribute 200, HELD_PASSIVE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SMOKE_BALL
...
; THICK_CLUB
	item_attribute 500, HELD_PASSIVE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; FOCUS_BAND
	item_attribute 200, HELD_CONSUMABLE, 30, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SAFARI_KEY
	item_attribute 6000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; ENERGYPOWDER
	item_attribute 500, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; ENERGY_ROOT
	item_attribute 800, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; HEAL_POWDER
	item_attribute 450, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; REVIVAL_HERB
	item_attribute 2800, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_PARTY, ITEMMENU_PARTY
; HARD_STONE
...
; SILPH_BADGE
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WEATHER_ROCK
	item_attribute 100, HELD_PASSIVE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; WIDE_LENS
	item_attribute 100, HELD_PASSIVE, 10, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; CHARCOAL
...
; BERSERK_GENE
	item_attribute 200, HELD_CONSUMABLE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; HELIX_FOSSIL
	item_attribute 4028, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; DOME_FOSSIL
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; OLD_AMBER
	item_attribute 1000, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SACRED_ASH
	item_attribute 200, HELD_NONE, 0, CANT_SELECT, MED, ITEMMENU_CLOSE, ITEMMENU_NOUSE
; HEAVY_BALL
...
; RAINBOW_WING
	item_attribute 0, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, KEY_ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; POKEMASK
	item_attribute 40000, HELD_PASSIVE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; BRICK_PIECE
	item_attribute 50, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; SURF_MAIL
	item_attribute 50, HELD_NONE, 0, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
...
; TM01
	item_attribute 12000, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM02
	item_attribute 8000, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM03
	item_attribute 12000, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM04
	item_attribute 8000, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; ITEM_C3
	item_attribute $9999, HELD_NONE, 0, CANT_SELECT | NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; TM05
	item_attribute 4000, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM06
	item_attribute 12000, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
; TM07
	item_attribute 8000, HELD_NONE, 0, CANT_SELECT | CANT_TOSS, TM_HM, ITEMMENU_PARTY, ITEMMENU_NOUSE
...
; ITEM_FA ($fb actually, as we added the TM51: Hail)
	item_attribute $9999, HELD_NONE, 0, CANT_SELECT | NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; $fc
	item_attribute $9999, HELD_NONE, 0, CANT_SELECT | NO_LIMITS, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; $fd

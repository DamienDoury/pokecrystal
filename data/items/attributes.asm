...
; BRIGHTPOWDER
	item_attribute 10, HELD_PASSIVE, 20, CANT_SELECT, ITEM, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; GREAT_BALL
...
; QUICK_CLAW
	item_attribute 100, HELD_QUICK_CLAW, 60, CANT_SELECT, BERRIES, ITEMMENU_NOUSE, ITEMMENU_NOUSE
; PSNCUREBERRY

...
MapGroup_Goldenrod:
	...
	map GoldenrodHospital1F, TILESET_HOSPITAL, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodHospitalOffice, TILESET_HOSPITAL, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodHospitalSecret, TILESET_HOSPITAL, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodHospitalCorridor, TILESET_HOSPITAL, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map GoldenrodHospitalRoom, TILESET_HOSPITAL, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE

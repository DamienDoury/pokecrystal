...
MapGroup_Dungeons:
	...
	map CeruleanCaveB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CeruleanCaveB2F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CeruleanCaveB3F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup_Goldenrod:
	...
	map GoldenrodHospitalSecret, TILESET_HOSPITAL, INDOOR, LANDMARK_HOSPITAL, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE

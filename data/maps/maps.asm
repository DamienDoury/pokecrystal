...
MapGroup_Dungeons:
	...
	map SafariZoneFuchsiaGateBeta, TILESET_GATE, GATE, LANDMARK_SAFARI_ZONE, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneBeta, TILESET_PARK, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map CeruleanGymBadgeSpeechHouse, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPoliceStation, TILESET_GAME_CORNER, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanCity, TILESET_KANTO_WAVES, TOWN, LANDMARK_CERULEAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_Fuchsia:
	...
	map WardensNeighborHouse, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE

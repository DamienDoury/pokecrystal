...
MapGroup_Dungeons:
	...
	map SeafoamW1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, LANDMARK_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafoamE1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, LANDMARK_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafoamB1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, LANDMARK_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_OCEAN

...
MapGroup_Cinnabar:
	...
	map SeafoamGymB1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_MORN, FISHGROUP_NONE
	map SeafoamGymB2F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_MORN, FISHGROUP_NONE
	map SeafoamGymB3F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_UNION_CAVE, TRUE, PALETTE_MORN, FISHGROUP_NONE

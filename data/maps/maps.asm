...
MapGroup_Olivine:
	...
	map Route38, TILESET_JOHTO_WAVES, ROUTE, LANDMARK_ROUTE_38, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route39, TILESET_JOHTO_WAVES, ROUTE, LANDMARK_ROUTE_39, MUSIC_ROUTE_37, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map OlivineCity, TILESET_JOHTO_WAVES, TOWN, LANDMARK_OLIVINE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	assert_table_length NUM_OLIVINE_MAPS

MapGroup_Mahogany:
	table_width MAP_LENGTH, MapGroup_Mahogany
	map MahoganyRedGyaradosSpeechHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_MAHOGANY_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Dungeons:
	...
	map BurnedTower1F, TILESET_TOWER, DUNGEON, LANDMARK_BURNED_TOWER, MUSIC_BURNED_TOWER, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	map BurnedTowerB1F, TILESET_CAVE, CAVE, LANDMARK_BURNED_TOWER, MUSIC_BURNED_TOWER, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map DiglettsCave, TILESET_CAVE, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DIGLETTS_CAVE, TRUE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map SafariZoneFuchsiaGateBeta, TILESET_GATE, GATE, LANDMARK_SAFARI_ZONE, MUSIC_SAFARI, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneBeta, TILESET_PARK, ROUTE, LANDMARK_SAFARI_ZONE, MUSIC_SAFARI, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map VictoryRoad, TILESET_CAVE, CAVE, LANDMARK_VICTORY_ROAD, MUSIC_VICTORY_ROAD, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map SeafoamW1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafoamE1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, FALSE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafoamB1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map SeafoamB2F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_WHIRL_ISLANDS
	map SeafoamB3F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_OCEAN
	map SeafoamB4F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_MORN, FISHGROUP_OCEAN
	map SeafoamB5F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_MORN, FISHGROUP_OCEAN
	map SeafoamB6F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_MORN, FISHGROUP_OCEAN
	map CeruleanCaveEntrance, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CeruleanCaveB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_DARK, FISHGROUP_NONE
	map CeruleanCaveB2F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_DARK, FISHGROUP_NONE
	map CeruleanCaveB3F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CAVE, MUSIC_DRAGONS_DEN, TRUE, PALETTE_DARK, FISHGROUP_NONE
...
MapGroup_Ecruteak:
	...
	map EcruteakFaunaHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EcruteakPoliceStation, TILESET_GAME_CORNER, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map EcruteakRemoteWorkHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map CarpetShop, TILESET_TRADITIONAL_HOUSE, INDOOR, LANDMARK_ECRUTEAK_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Blackthorn:
	...
	map BlackthornDragonSpeechHouse, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BlackthornEmysHouse, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map MoveDeletersHouse, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_BLACKTHORN_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map SeafoamGym, TILESET_CAVE, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map Route19, TILESET_KANTO_WAVES, ROUTE, LANDMARK_ROUTE_19, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route20, TILESET_KANTO_WAVES, ROUTE, LANDMARK_ROUTE_20, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route21, TILESET_KANTO_WAVES, ROUTE, LANDMARK_ROUTE_21, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CinnabarIsland, TILESET_KANTO_WAVES, TOWN, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR_ISLAND, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map SeafoamGymB1F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_MORN, FISHGROUP_NONE
	map SeafoamGymB2F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_MORN, FISHGROUP_NONE
	map SeafoamGymB3F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_MORN, FISHGROUP_NONE
	map SeafoamGymB4F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_MORN, FISHGROUP_NONE
	map SeafoamGymB5F, TILESET_CAVE, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_MORN, FISHGROUP_NONE
	assert_table_length NUM_CINNABAR_MAPS

MapGroup_Cerulean:
	table_width MAP_LENGTH, MapGroup_Cerulean
	map CeruleanGymBadgeSpeechHouse, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_FUCHSIA, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanPoliceStation, TILESET_GAME_CORNER, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_FUCHSIA, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanTradeSpeechHouse, TILESET_HOUSE, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_FUCHSIA, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanMart, TILESET_MART, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_FUCHSIA, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map BillsHouse, TILESET_FACILITY, INDOOR, LANDMARK_ROUTE_25, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route4, TILESET_KANTO_WAVES, ROUTE, LANDMARK_ROUTE_4, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route9, TILESET_KANTO_WAVES, ROUTE, LANDMARK_ROUTE_9, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route10North, TILESET_KANTO_WAVES, ROUTE, LANDMARK_ROUTE_10, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route24, TILESET_KANTO_WAVES, ROUTE, LANDMARK_ROUTE_24, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route25, TILESET_KANTO_WAVES, ROUTE, LANDMARK_ROUTE_25, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map CeruleanCity, TILESET_KANTO_WAVES, TOWN, LANDMARK_CERULEAN_CITY, MUSIC_CERULEAN_FUCHSIA, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route4Tunnel, TILESET_CAVE, CAVE, LANDMARK_ROUTE_4, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Azalea:
	...
	map CharcoalKiln, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_AZALEA_TOWN, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_LakeOfRage:
	...
	map LakeOfRage, TILESET_JOHTO, ROUTE, LANDMARK_LAKE_OF_RAGE, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_GYARADOS
...
MapGroup_Goldenrod:
	...
	map GoldenrodDeptStoreRoof, TILESET_MART, ROUTE, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map IlexForestAzaleaGate, TILESET_GATE, GATE, LANDMARK_ILEX_FOREST, MUSIC_ROUTE_36, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map GoldenrodHospital1F, TILESET_HOSPITAL, INDOOR, LANDMARK_HOSPITAL, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map GoldenrodHospitalOffice, TILESET_HOSPITAL, INDOOR, LANDMARK_HOSPITAL, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map GoldenrodHospitalCorridor, TILESET_HOSPITAL, INDOOR, LANDMARK_HOSPITAL, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map GoldenrodHospitalRoom, TILESET_HOSPITAL, INDOOR, LANDMARK_HOSPITAL, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map GoldenrodClapHouse, TILESET_HOUSE, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Pallet:
	...
	map Route1, TILESET_KANTO_WAVES, ROUTE, LANDMARK_ROUTE_1, MUSIC_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PalletTown, TILESET_KANTO_WAVES, TOWN, LANDMARK_PALLET_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Pewter:
	...
	map Route3, TILESET_KANTO_WAVES, ROUTE, LANDMARK_ROUTE_3, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PewterCity, TILESET_KANTO_WAVES, TOWN, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map PewterMuseum1F, TILESET_MUSEUM, CAVE, LANDMARK_PEWTER_CITY, MUSIC_MT_MOON, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map PewterMuseum2F, TILESET_MUSEUM, CAVE, LANDMARK_PEWTER_CITY, MUSIC_MT_MOON, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_FastShip:
	...
	map OlivinePortPassage, TILESET_UNDERGROUND, INDOOR, LANDMARK_OLIVINE_CITY, MUSIC_VIOLET_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionPortPassage, TILESET_UNDERGROUND, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map MountMoonSquare, TILESET_KANTO_WAVES, ROUTE, LANDMARK_MT_MOON, MUSIC_MT_MOON_SQUARE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map FuchsiaCity, TILESET_KANTO, TOWN, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_FUCHSIA, FALSE, PALETTE_AUTO, FISHGROUP_GYARADOS
	map FuchsiaMart, TILESET_MART, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_FUCHSIA, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneMainOffice, TILESET_GAME_CORNER, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_FUCHSIA, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaGym, TILESET_LAB, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsBrothersHouse, TILESET_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_FUCHSIA, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SafariZoneWardensHome, TILESET_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_FUCHSIA, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route15FuchsiaGate, TILESET_GATE, GATE, LANDMARK_ROUTE_15, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map WardensNeighborHouse, TILESET_LIGHTHOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_FUCHSIA, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaMovesHouse, TILESET_HOUSE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CERULEAN_FUCHSIA, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	...
	map CeladonMansionRoof, TILESET_MANSION, ROUTE, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map BedShop, TILESET_GAME_CORNER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map EusineHouse, TILESET_HOUSE, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_CELADON_MAPS

MapGroup_Cianwood:
	table_width MAP_LENGTH, MapGroup_Cianwood
	map Route40, TILESET_JOHTO_WAVES, ROUTE, LANDMARK_ROUTE_40, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route41, TILESET_JOHTO_WAVES, ROUTE, LANDMARK_ROUTE_41, MUSIC_ROUTE_36, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CianwoodCity, TILESET_JOHTO_WAVES, TOWN, LANDMARK_CIANWOOD_CITY, MUSIC_ECRUTEAK_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map Route2, TILESET_KANTO_WAVES, ROUTE, LANDMARK_ROUTE_2, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route22, TILESET_KANTO_WAVES, ROUTE, LANDMARK_ROUTE_22, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map ViridianCity, TILESET_KANTO_WAVES, TOWN, LANDMARK_VIRIDIAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	...
	map ViridianForest, TILESET_FOREST, ROUTE, LANDMARK_VIRIDIAN_FOREST, MUSIC_VIRIDIAN_FOREST, FALSE, PALETTE_AUTO, FISHGROUP_POND
	assert_table_length NUM_VIRIDIAN_MAPS

MapGroup_NewBark:
	table_width MAP_LENGTH, MapGroup_NewBark
	map Route26, TILESET_JOHTO_WAVES, ROUTE, LANDMARK_ROUTE_26, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route27, TILESET_JOHTO_WAVES, ROUTE, LANDMARK_ROUTE_27, MUSIC_ROUTE_26, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route29, TILESET_JOHTO_WAVES, ROUTE, LANDMARK_ROUTE_29, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map NewBarkTown, TILESET_JOHTO_WAVES, TOWN, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map PlayersNeighborsHouse, TILESET_PLAYERS_HOUSE, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	...
	map Route5, TILESET_KANTO_WAVES, ROUTE, LANDMARK_ROUTE_5, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map VaccinationCenter1F, TILESET_HOSPITAL, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map VaccinationCenterCorridor, TILESET_HOSPITAL, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map VaccinationCenterRoom, TILESET_HOSPITAL, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map MrAntonsHouse, TILESET_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCoElevator, TILESET_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map SilphCoResearch, TILESET_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map Akiba1F, TILESET_MANSION, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map Akiba2F, TILESET_MANSION, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map Akiba3F, TILESET_MART, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	assert_table_length NUM_SAFFRON_MAPS

MapGroup_Cherrygrove:
	table_width MAP_LENGTH, MapGroup_Cherrygrove
	map Route30, TILESET_JOHTO_WAVES, ROUTE, LANDMARK_ROUTE_30, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route31, TILESET_JOHTO_WAVES, ROUTE, LANDMARK_ROUTE_31, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map CherrygroveCity, TILESET_JOHTO_WAVES, TOWN, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE

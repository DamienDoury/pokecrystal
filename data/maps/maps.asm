...
MapGroup_Goldenrod:
	...
	map GoldenrodHospital1F, TILESET_HOSPITAL, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map GoldenrodHospitalOffice, TILESET_HOSPITAL, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map GoldenrodHospitalSecret, TILESET_HOSPITAL, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map GoldenrodHospitalCorridor, TILESET_HOSPITAL, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
	map GoldenrodHospitalRoom, TILESET_HOSPITAL, INDOOR, LANDMARK_GOLDENROD_CITY, MUSIC_GOLDENROD_CITY, TRUE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Viridian:
	...
	map ViridianForest, TILESET_FOREST, ROUTE, LANDMARK_VIRIDIAN_FOREST, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_POND

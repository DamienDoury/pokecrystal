...
MapGroup_Dungeons:
	...
	map SafariZoneFuchsiaGateBeta, TILESET_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanCaveEntrance, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CeruleanCaveB1F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CeruleanCaveB2F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_NONE
	map CeruleanCaveB3F, TILESET_DARK_CAVE, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_DRAGONS_DEN, TRUE, PALETTE_NITE, FISHGROUP_NONE
...
MapGroup_Viridian:
	...
	map ViridianForest, TILESET_FOREST, ROUTE, LANDMARK_ROUTE_2, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_POND

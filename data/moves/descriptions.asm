...
StompDescription:
if DEF(_FR_FR)
	db   "30<PERCENT> peur. Dmg x2"
	next "contre LILLIPUT.@"
else
...
DisableDescription:
if DEF(_FR_FR)
	db   "Bloque la dernière"
	next "capacité 4 tours.@"
else
...
FlameWheelDescription:
	if DEF(_FR_FR)
	db   "Inflige des dmg et"
	next "monte la VITESSE.@"
else
	db   "Hurts enemy and"

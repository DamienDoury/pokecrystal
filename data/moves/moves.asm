...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move SKULL_BASH,   EFFECT_SKULL_BASH,        120, NORMAL,       	PHYSICAL,	100, 10,   0
	...
	move STRUGGLE,     EFFECT_STRUGGLE,	          30, NORMAL,       	PHYSICAL,	100,  1,   0
	...
	move SWEET_SCENT,  EFFECT_SWEET_SCENT,      0, NORMAL,       	STATUS,		100, 20,   0
